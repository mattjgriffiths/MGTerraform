...
variable "ingress_externalenabled" {
  type = bool
  description = "Container app ingress external enabled configuration"
}
variable "ingress_allowinsecure" {
  type = bool
  description = "Container app ingress allow insecure configuration"
}
variable "rg_name" {
  type = string
